...
@Component({
  ...
  <h1>Introduction to CSS Style binding</h1>
  <img src="{{angularLogo}}">

  <h1 [style.color]="titleStyle ? 'green' : 'pink'">Title Here</h1>

  <h2 [ngStyle]="titleStyles">and sub-title here</h2>
  
    `,
  /* assigns a value to a CSS style property
  based on a conditional handled in the component. If "titleStyle" is defined or true
  then color is green; else color is pink. 
    <h1 [style.color]="titleStyle ? 'green' : 'pink'">Title Here</h1>
  */
  styles: [`
    .red-title {
