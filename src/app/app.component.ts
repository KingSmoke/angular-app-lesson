...
@Component({
  ...
  <h1>Introduction to Event Binding</h1>
  <p>Event Binding sends data one-way from the view to the component class (the controller).</p> 
  <img src="{{angularLogo}}" (mouseenter)="myEvent1($event)">

  <button (click)="myEvent2($event)">myButton</button>
...
export class AppComponent {
  ...
  myEvent1(event) {
    console.log('mouseenter on angularLogo');
  }
  myEvent2(event) {
    console.log(event);
  }
