...
@Component({
  ...
  <h1>Introduction to CSS Class binding</h1>
  <img src="{{angularLogo}}" (mouseenter)="myEvent1($event)">

  <p>CSS Class binding allows the component to bind CSS classes to elements in the template.</p>
  <h2 [ngClass]="titleClasses">This h2 header has multiple classes through the component.</h2>
